...
var TYPE_DELIMITER, IS_CONTAINER, IS_EXTENDED_CLASS, classBase;
var init_clazz = __esm({
  "node_modules/echarts/lib/util/clazz.js"() {
    init_tslib_es62();
    init_util();
    TYPE_DELIMITER = ".";
...
var init_makeStyleMapper = __esm({
  "node_modules/echarts/lib/model/mixin/makeStyleMapper.js"() {
    init_util();
  }
});
...
var RADIAN_EPSILON, ROUND_SUPPORTED_PRECISION_MAX, MAX_SAFE_INTEGER, TIME_REG;
...
var ECHARTS_PREFIX, storedLogs, hasConsole;
var init_log = __esm({
  "node_modules/echarts/lib/util/log.js"() {
    init_util();
    ECHARTS_PREFIX = "[ECharts] ";
    storedLogs = {};
...
var DUMMY_COMPONENT_NAME_PREFIX, INTERNAL_COMPONENT_ID_PREFIX, TEXT_STYLE_OPTIONS, innerUniqueIndex, SINGLE_REFERRING, MULTIPLE_REFERRING;
var init_model = __esm({
  "node_modules/echarts/lib/util/model.js"() {
    ...
    init_number();
    init_log();
    DUMMY_COMPONENT_NAME_PREFIX = "series\0";
    ...
    innerUniqueIndex = getRandomIdBase();
    SINGLE_REFERRING = {
      useDefault: true,
      enableAll: false,
      enableNone: false
...
var init_innerStore = __esm({
  "node_modules/echarts/lib/util/innerStore.js"() {
    init_model();
    getECData = makeInner();
    setCommonECData = function(seriesIndex, dataType, dataIdx, el) {
      if (el) {
...
var _highlightNextDigit, _highlightKeyMap, getSavedStates, getComponentStates, HOVER_STATE_NORMAL, HOVER_STATE_BLUR, HOVER_STATE_EMPHASIS, SPECIAL_STATES, DISPLAY_STATES, Z2_EMPHASIS_LIFT, Z2_SELECT_LIFT, HIGHLIGHT_ACTION_TYPE, DOWNPLAY_ACTION_TYPE, SELECT_ACTION_TYPE, UNSELECT_ACTION_TYPE, TOGGLE_SELECT_ACTION_TYPE, OTHER_STATES, defaultStyleGetterMap;
var init_states = __esm({
  "node_modules/echarts/lib/util/states.js"() {
    ...
    OTHER_STATES = ["emphasis", "blur", "select"];
...
var CMD, points, mathSqrt, mathAtan2;
var init_transformPath = __esm({
  "node_modules/zrender/lib/tool/transformPath.js"() {
    init_PathProxy();
    init_vector();
    CMD = PathProxy_default.CMD;
    points = [[], [], []];
    mathSqrt = Math.sqrt;
...
var mathSqrt2, mathSin, mathCos, PI, commandReg, numberReg, SVGPath;
var init_path = __esm({
  "node_modules/zrender/lib/tool/path.js"() {
    init_tslib_es6();
    init_Path();
    ...
    mathCos = Math.cos;
    PI = Math.PI;
    commandReg = /([mlvhzcqtsa])([^mlvhzcqtsa]*)/ig;
    numberReg = /-?([0-9]*\.)?[0-9]+([eE]-?[0-9]+)?/g;
    SVGPath = function(_super) {
...
var CircleShape, Circle, Circle_default;
var init_Circle = __esm({
  "node_modules/zrender/lib/graphic/shape/Circle.js"() {
    init_tslib_es6();
    init_Path();
    CircleShape = /* @__PURE__ */ function() {
...
var EllipseShape, Ellipse, Ellipse_default;
var init_Ellipse = __esm({
  "node_modules/zrender/lib/graphic/shape/Ellipse.js"() {
    init_tslib_es6();
    init_Path();
    EllipseShape = /* @__PURE__ */ function() {
...
var PI2, PI22, mathSin2, mathCos2, mathACos, mathATan2, mathAbs, mathSqrt3, mathMax, mathMin, e;
var init_roundSector = __esm({
  "node_modules/zrender/lib/graphic/helper/roundSector.js"() {
    init_util();
    PI2 = Math.PI;
    PI22 = PI2 * 2;
...
var SectorShape, Sector, Sector_default;
var init_Sector = __esm({
  "node_modules/zrender/lib/graphic/shape/Sector.js"() {
    init_tslib_es6();
    init_Path();
    init_roundSector();
    SectorShape = /* @__PURE__ */ function() {
...
var RingShape, Ring, Ring_default;
var init_Ring = __esm({
  "node_modules/zrender/lib/graphic/shape/Ring.js"() {
    init_tslib_es6();
    init_Path();
    RingShape = /* @__PURE__ */ function() {
      function RingShape2() {
        this.cx = 0;
        this.cy = 0;
        this.r = 0;
...
var PolygonShape, Polygon, Polygon_default;
var init_Polygon = __esm({
  "node_modules/zrender/lib/graphic/shape/Polygon.js"() {
    init_tslib_es6();
    init_Path();
    init_poly();
    PolygonShape = /* @__PURE__ */ function() {
...
var PolylineShape, Polyline, Polyline_default;
var init_Polyline = __esm({
  "node_modules/zrender/lib/graphic/shape/Polyline.js"() {
    init_tslib_es6();
    init_Path();
    init_poly();
    PolylineShape = /* @__PURE__ */ function() {
    ...
    Polyline_default = Polyline;
  }
});

// node_modules/zrender/lib/graphic/shape/Line.js
var subPixelOptimizeOutputShape, LineShape, Line, Line_default;
var init_Line = __esm({
  "node_modules/zrender/lib/graphic/shape/Line.js"() {
    init_tslib_es6();
    init_Path();
...
var out, BezierCurveShape, BezierCurve, BezierCurve_default;
var init_BezierCurve = __esm({
  "node_modules/zrender/lib/graphic/shape/BezierCurve.js"() {
    init_tslib_es6();
    init_Path();
    init_vector();
    init_curve();
    out = [];
    BezierCurveShape = /* @__PURE__ */ function() {
    ...
    BezierCurve_default = BezierCurve;
  }
});

// node_modules/zrender/lib/graphic/shape/Arc.js
var ArcShape, Arc, Arc_default;
var init_Arc = __esm({
  "node_modules/zrender/lib/graphic/shape/Arc.js"() {
    init_tslib_es6();
    init_Path();
    ArcShape = /* @__PURE__ */ function() {
      function ArcShape2() {
        this.cx = 0;
        this.cy = 0;
        this.r = 0;
...
var LinearGradient, LinearGradient_default;
var init_LinearGradient = __esm({
  "node_modules/zrender/lib/graphic/LinearGradient.js"() {
    ...
    LinearGradient_default = LinearGradient;
  }
});

// node_modules/zrender/lib/graphic/RadialGradient.js
var RadialGradient, RadialGradient_default;
var init_RadialGradient = __esm({
  "node_modules/zrender/lib/graphic/RadialGradient.js"() {
    ...
    RadialGradient_default = RadialGradient;
  }
});

// node_modules/zrender/lib/core/OrientedBoundingRect.js
var extent, extent2, minTv, maxTv, OrientedBoundingRect, OrientedBoundingRect_default;
var init_OrientedBoundingRect = __esm({
  "node_modules/zrender/lib/core/OrientedBoundingRect.js"() {
    init_Point();
    extent = [0, 0];
    extent2 = [0, 0];
    ...
    OrientedBoundingRect_default = OrientedBoundingRect;
  }
});

// node_modules/zrender/lib/graphic/IncrementalDisplayable.js
var m, IncrementalDisplayable, IncrementalDisplayable_default;
var init_IncrementalDisplayable = __esm({
  "node_modules/zrender/lib/graphic/IncrementalDisplayable.js"() {
    init_tslib_es6();
    init_Displayable();
    init_BoundingRect();
    m = [];
    IncrementalDisplayable = function(_super) {
    ...
    IncrementalDisplayable_default = IncrementalDisplayable;
  }
});
...
var transitionStore;
var init_basicTransition = __esm({
  "node_modules/echarts/lib/animation/basicTransition.js"() {
    init_util();
    init_model();
...
var mathMax2, mathMin2, _customShapeMap, extendPathFromString, mergePath2, subPixelOptimize2;
var init_graphic2 = __esm({
  "node_modules/echarts/lib/util/graphic.js"() {
    init_path();
    init_matrix();
    init_vector();
    ...
    init_RadialGradient();
    init_BoundingRect();
    init_OrientedBoundingRect();
    init_Point();
    init_IncrementalDisplayable();
    init_subPixelOptimize();
    init_util();
    init_innerStore();
    ...
    mathMin2 = Math.min;
    _customShapeMap = {};
    extendPathFromString = extendFromString;
    mergePath2 = mergePath;
    subPixelOptimize2 = subPixelOptimize;
...
var EMPTY_OBJ, TEXT_PROPS_WITH_GLOBAL, TEXT_PROPS_SELF, TEXT_PROPS_BOX, labelInner;
var init_labelStyle = __esm({
  "node_modules/echarts/lib/label/labelStyle.js"() {
    init_Text();
    init_util();
    init_states();
    ...
    init_graphic2();
    EMPTY_OBJ = {};
    TEXT_PROPS_WITH_GLOBAL = ["fontStyle", "fontWeight", "fontSize", "fontFamily", "textShadowColor", "textShadowBlur", "textShadowOffsetX", "textShadowOffsetY"];
    TEXT_PROPS_SELF = ["align", "lineHeight", "width", "height", "tag", "verticalAlign", "ellipsis"];
    TEXT_PROPS_BOX = ["padding", "borderWidth", "borderRadius", "borderDashOffset", "backgroundColor", "borderColor", "shadowColor", "shadowBlur", "shadowOffsetX", "shadowOffsetY"];
    labelInner = makeInner();
  }
});

// node_modules/echarts/lib/model/mixin/textStyle.js
var PATH_COLOR, textStyleParams, tmpText, TextStyleMixin, textStyle_default;
var init_textStyle = __esm({
  "node_modules/echarts/lib/model/mixin/textStyle.js"() {
    init_labelStyle();
    init_Text();
    PATH_COLOR = ["textStyle", "color"];
    textStyleParams = ["fontStyle", "fontWeight", "fontSize", "fontFamily", "padding", "lineHeight", "rich", "width", "height", "overflow"];
    tmpText = new Text_default();
    TextStyleMixin = /** @class */
    function() {
    ...
    textStyle_default = TextStyleMixin;
  }
});
...
var LOCALE_ZH, LOCALE_EN, DEFAULT_LOCALE, localeStorage, localeModels, SYSTEM_LANG;
var init_locale = __esm({
  "node_modules/echarts/lib/core/locale.js"() {
    ...
    localeStorage = {};
    localeModels = {};
    SYSTEM_LANG = !env_default.domSupported ? DEFAULT_LOCALE : function() {
      var langStr = (
...
var ONE_SECOND, ONE_MINUTE, ONE_HOUR, ONE_DAY, ONE_YEAR, defaultLeveledFormatter, fullDayFormatter, fullLeveledFormatter, primaryTimeUnits, timeUnits;
var init_time = __esm({
  "node_modules/echarts/lib/util/time.js"() {
    init_util();
    init_number();
...
var normalizeCssArray2, TPL_VAR_ALIAS, wrapVar;
var init_format = __esm({
  "node_modules/echarts/lib/util/format.js"() {
    ...
    init_parseText();
    init_getTextRect();
    normalizeCssArray2 = normalizeCssArray;
    TPL_VAR_ALIAS = ["a", "b", "c", "d", "e", "f", "g"];
...
var each2, LOCATION_PARAMS, HV_NAMES, box, vbox, hbox;
var init_layout = __esm({
  "node_modules/echarts/lib/util/layout.js"() {
    ...
    HV_NAMES = [["width", "left", "right"], ["height", "top", "bottom"]];
    box = boxLayout;
    vbox = curry(boxLayout, "vertical");
    hbox = curry(boxLayout, "horizontal");
  }
});
...
var inner, ComponentModel, Component_default;
var init_Component = __esm({
  "node_modules/echarts/lib/model/Component.js"() {
    init_tslib_es62();
    init_util();
    ...
    Component_default = ComponentModel;
  }
});
...
var innerColor, innerDecal, PaletteMixin;
var init_palette = __esm({
  "node_modules/echarts/lib/model/mixin/palette.js"() {
    init_model();
    innerColor = makeInner();
...
var VISUAL_DIMENSIONS, SOURCE_FORMAT_ORIGINAL, SOURCE_FORMAT_ARRAY_ROWS, SOURCE_FORMAT_OBJECT_ROWS, SOURCE_FORMAT_KEYED_COLUMNS, SOURCE_FORMAT_TYPED_ARRAY, SOURCE_FORMAT_UNKNOWN, SERIES_LAYOUT_BY_COLUMN, SERIES_LAYOUT_BY_ROW;
...
var BE_ORDINAL, innerGlobalModel;
var init_sourceHelper = __esm({
  "node_modules/echarts/lib/data/helper/sourceHelper.js"() {
    init_model();
    init_util();
    init_types();
...
var _a, _b, _c, providerMethods, mountMethods, DefaultDataProvider, getItemSimply, rawSourceItemGetterMap, countSimply, rawSourceDataCounterMap, getRawValueSimply, rawSourceValueGetterMap;
var init_dataProvider = __esm({
  "node_modules/echarts/lib/data/helper/dataProvider.js"() {
    ...
    rawSourceItemGetterMap = (_a = {}, _a[SOURCE_FORMAT_ARRAY_ROWS + "_" + SERIES_LAYOUT_BY_COLUMN] = function(rawData, startIndex, dimsDef, idx) {
    ...
    countSimply = function(rawData, startIndex, dimsDef) {
      return rawData.length;
    };
    rawSourceDataCounterMap = (_b = {}, _b[SOURCE_FORMAT_ARRAY_ROWS + "_" + SERIES_LAYOUT_BY_COLUMN] = function(rawData, startIndex, dimsDef) {
    ...
    getRawValueSimply = function(dataItem, dimIndex, property) {
      return dataItem[dimIndex];
    };
    rawSourceValueGetterMap = (_c = {}, _c[SOURCE_FORMAT_ARRAY_ROWS] = getRawValueSimply, _c[SOURCE_FORMAT_OBJECT_ROWS] = function(dataItem, dimIndex, property) {
...
var DIMENSION_LABEL_REG, DataFormatMixin;
var init_dataFormat = __esm({
  "node_modules/echarts/lib/model/mixin/dataFormat.js"() {
    init_util();
    init_dataProvider();
    init_format();
    init_log();
    DIMENSION_LABEL_REG = /\{@(.+?)\}/g;
    DataFormatMixin = /** @class */
    function() {
...
var valueParserMap, ORDER_COMPARISON_OP_MAP, FilterOrderComparator, SortOrderComparator, FilterEqualityComparator;
var init_dataValueHelper = __esm({
  "node_modules/echarts/lib/data/helper/dataValueHelper.js"() {
    init_number();
    init_util();
    init_log();
    valueParserMap = createHashMap({
      "number": function(val) {
    ...
    FilterEqualityComparator = /** @class */
    function() {
...
var ExternalSource, externalTransformMap;
...
var UNDEFINED, CtorUint32Array, CtorUint16Array, CtorInt32Array, CtorFloat64Array, dataCtors, defaultDimValueGetters, DataStore, DataStore_default;
var init_DataStore = __esm({
  "node_modules/echarts/lib/data/DataStore.js"() {
    ...
    CtorFloat64Array = typeof Float64Array === UNDEFINED ? Array : Float64Array;
    dataCtors = {
...
var TOOLTIP_LINE_HEIGHT_CSS, HTML_GAPS, RICH_TEXT_GAPS, TooltipMarkupStyleCreator;
var init_tooltipMarkup = __esm({
  "node_modules/echarts/lib/component/tooltip/tooltipMarkup.js"() {
    init_format();
    init_util();
    init_dataValueHelper();
    init_number();
    TOOLTIP_LINE_HEIGHT_CSS = "line-height:1";
    HTML_GAPS = [0, 10, 20, 30];
    RICH_TEXT_GAPS = ["", "\n", "\n\n", "\n\n\n"];
    TooltipMarkupStyleCreator = /** @class */
    function() {
...
var init_seriesFormatTooltip = __esm({
  "node_modules/echarts/lib/component/tooltip/seriesFormatTooltip.js"() {
    init_util();
    init_tooltipMarkup();
    init_dataProvider();
...
var inner2, SERIES_UNIVERSAL_TRANSITION_PROP, SeriesModel, Series_default;
var init_Series = __esm({
  "node_modules/echarts/lib/model/Series.js"() {
    ...
    inner2 = makeInner();
    SERIES_UNIVERSAL_TRANSITION_PROP = "__universalTransitionEnabled";
    SeriesModel = /** @class */
    function(_super) {
    ...
    Series_default = SeriesModel;
  }
});

// node_modules/echarts/lib/view/Component.js
var ComponentView, Component_default2;
var init_Component2 = __esm({
  "node_modules/echarts/lib/view/Component.js"() {
    ...
    Component_default2 = ComponentView;
  }
});
...
var init_createRenderPlanner = __esm({
  "node_modules/echarts/lib/chart/helper/createRenderPlanner.js"() {
    init_model();
  }
});
...
var inner3, renderPlanner, ChartView, progressMethodMap, Chart_default;
...
var ORIGIN_METHOD, RATE, THROTTLE_TYPE;
...
var platform, decalColor, globalDefault_default;
var init_globalDefault = __esm({
  "node_modules/echarts/lib/model/globalDefault.js"() {
    platform = "";
    if (typeof navigator !== "undefined") {
      platform = navigator.platform || "";
    }
    decalColor = "rgba(0, 0, 0, 0.2)";
    globalDefault_default = {
      darkMode: "auto",
...
var init_internalComponentCreator = __esm({
  "node_modules/echarts/lib/model/internalComponentCreator.js"() {
    init_util();
    init_model();
...
var reCreateSeriesIndices, assertSeriesInitialized, initBase, OPTION_INNER_KEY, OPTION_INNER_VALUE, BUITIN_COMPONENTS_MAP, BUILTIN_CHARTS_MAP, componetsMissingLogPrinted, GlobalModel, Global_default;
var init_Global = __esm({
  "node_modules/echarts/lib/model/Global.js"() {
    ...
    Global_default = GlobalModel;
  }
});

// node_modules/echarts/lib/core/ExtensionAPI.js
var availableMethods, ExtensionAPI, ExtensionAPI_default;
var init_ExtensionAPI = __esm({
  "node_modules/echarts/lib/core/ExtensionAPI.js"() {
    init_util();
    availableMethods = [
      "getDom",
    ...
    ExtensionAPI_default = ExtensionAPI;
  }
});

// node_modules/echarts/lib/core/CoordinateSystem.js
var coordinateSystemCreators, CoordinateSystemManager, CoordinateSystem_default;
var init_CoordinateSystem = __esm({
  "node_modules/echarts/lib/core/CoordinateSystem.js"() {
    init_util();
    ...
    CoordinateSystem_default = CoordinateSystemManager;
  }
});
...
var QUERY_REG, OptionManager, OptionManager_default;
var init_OptionManager = __esm({
  "node_modules/echarts/lib/model/OptionManager.js"() {
    init_model();
    init_util();
    init_log();
    ...
    OptionManager_default = OptionManager;
  }
});
...
var each3, isObject2, POSSIBLE_STYLES;
var init_compatStyle = __esm({
  "node_modules/echarts/lib/preprocessor/helper/compatStyle.js"() {
    init_util();
    init_model();
    init_log();
...
var LAYOUT_PROPERTIES, COMPATITABLE_COMPONENTS, BAR_ITEM_STYLE_MAP;
var init_backwardCompat = __esm({
  "node_modules/echarts/lib/preprocessor/backwardCompat.js"() {
    init_util();
    init_compatStyle();
    init_model();
    ...
    BAR_ITEM_STYLE_MAP = [["borderRadius", "barBorderRadius"], ["borderColor", "barBorderColor"], ["borderWidth", "barBorderWidth"]];
  }
});
...
var inner4, defaultStyleMappers, defaultColorKey, seriesStyleTask, sharedModel, dataStyleTask, dataColorPaletteTask;
...
var Scheduler, singleSeriesTaskProgress, ecModelMock, apiMock, seriesType, Scheduler_default;
var init_Scheduler = __esm({
  "node_modules/echarts/lib/core/Scheduler.js"() {
    ...
    singleSeriesTaskProgress = makeSeriesTaskProgress(0);
    ecModelMock = {};
    apiMock = {};
...
var colorAll, light_default;
var init_light = __esm({
  "node_modules/echarts/lib/theme/light.js"() {
    colorAll = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1", "#e7bcf3", "#9d96f5", "#8378EA", "#96BFFF"];
    light_default = {
      color: colorAll,
...
var contrastColor, backgroundColor, axisCommon, colorPalette, theme, dark_default;
var init_dark = __esm({
  "node_modules/echarts/lib/theme/dark.js"() {
    ...
    colorPalette = ["#4992ff", "#7cffb2", "#fddd60", "#ff6e76", "#58d9f9", "#05c091", "#ff8a45", "#8d48e3", "#dd79ff"];
    theme = {
      darkMode: true,
      color: colorPalette,
      backgroundColor,
...
var init_ECEventProcessor = __esm({
  "node_modules/echarts/lib/util/ECEventProcessor.js"() {
    init_util();
    init_clazz();
    ECEventProcessor = /** @class */
    function() {
...
var init_symbol = __esm({
  "node_modules/echarts/lib/visual/symbol.js"() {
    init_util();
    SYMBOL_PROPS_WITH_CB = ["symbol", "symbolSize", "symbolRotate", "symbolOffset"];
    SYMBOL_PROPS = SYMBOL_PROPS_WITH_CB.concat(["symbolKeepAspect"]);
    seriesSymbolTask = {
      createOnAllSeries: true,
      // For legend.
      performRawSeries: true,
...
var init_dataSelectAction = __esm({
  "node_modules/echarts/lib/legacy/dataSelectAction.js"() {
    init_util();
    init_log();
    init_model();
...
var wmUniqueIndex, supportDefineProperty, WeakMap, WeakMap_default;
var init_WeakMap = __esm({
  "node_modules/zrender/lib/core/WeakMap.js"() {
    wmUniqueIndex = Math.round(Math.random() * 9);
    supportDefineProperty = typeof Object.defineProperty === "function";
    WeakMap = function() {
      function WeakMap2() {
...
var Triangle, Diamond, Pin, Arrow, symbolCtors, symbolShapeMakers, symbolBuildProxies, SymbolClz;
...
var decalMap, decalCache, decalKeys;
var init_decal = __esm({
  "node_modules/echarts/lib/util/decal.js"() {
    init_WeakMap();
    init_LRU();
    init_util();
    ...
    init_graphic();
    init_platform();
    decalMap = new WeakMap_default();
    decalCache = new LRU_default(100);
    decalKeys = ["symbol", "symbolSize", "symbolKeepAspect", "color", "backgroundColor", "dashArrayX", "dashArrayY", "maxTileWidth", "maxTileHeight"];
  }
});
...
var init_lifecycle = __esm({
  "node_modules/echarts/lib/core/lifecycle.js"() {
    init_Eventful();
    lifecycle = new Eventful_default();
...
var version, dependencies, TEST_FRAME_REMAIN_TIME, PRIORITY_PROCESSOR_SERIES_FILTER, PRIORITY_PROCESSOR_DATASTACK, PRIORITY_PROCESSOR_FILTER, PRIORITY_PROCESSOR_DEFAULT, PRIORITY_PROCESSOR_STATISTIC, PRIORITY_VISUAL_LAYOUT, PRIORITY_VISUAL_PROGRESSIVE_LAYOUT, PRIORITY_VISUAL_GLOBAL, PRIORITY_VISUAL_CHART, PRIORITY_VISUAL_COMPONENT, PRIORITY_VISUAL_CHART_DATA_CUSTOM, PRIORITY_VISUAL_POST_CHART_LAYOUT, PRIORITY_VISUAL_BRUSH, PRIORITY_VISUAL_ARIA, PRIORITY_VISUAL_DECAL, PRIORITY, IN_MAIN_PROCESS_KEY, PENDING_UPDATE, STATUS_NEEDS_UPDATE_KEY, ACTION_REG, CONNECT_STATUS_KEY, CONNECT_STATUS_PENDING, CONNECT_STATUS_UPDATING, CONNECT_STATUS_UPDATED, MessageCenter, messageCenterProto, prepare, prepareView, updateDirectly, updateMethods, doConvertPixel, updateStreamModes, doDispatchAction, flushPendingActions, triggerUpdatedEvent, bindRenderedEvent, bindMouseEvent, render, renderComponents, renderSeries, createExtensionAPI, enableConnect, markStatusToUpdate, applyChangedStates, ECharts, echartsProto, MOUSE_EVENT_NAMES, actions, eventActionMap, dataProcessorFuncs, optionPreprocessorFuncs, visualFuncs, themeStorage, loadingEffects, instances, connectedGroups, idBase, groupIdBase, DOM_ATTRIBUTE_KEY, disConnect, registeredTasks, registerTransform, dataTool;
var init_echarts = __esm({
  "node_modules/echarts/lib/core/echarts.js"() {
    ...
    PENDING_UPDATE = "__pendingUpdate";
    ...
    MOUSE_EVENT_NAMES = ["click", "dblclick", "mouseover", "mouseout", "mousemove", "mousedown", "mouseup", "globalout", "contextmenu"];
    actions = {};
    eventActionMap = {};
    dataProcessorFuncs = [];
    optionPreprocessorFuncs = [];
    ...
    instances = {};
    connectedGroups = {};
    idBase = +/* @__PURE__ */ new Date() - 0;
    groupIdBase = +/* @__PURE__ */ new Date() - 0;
    DOM_ATTRIBUTE_KEY = "_echarts_instance_";
    disConnect = disconnect;
    registeredTasks = [];
    registerTransform = registerExternalTransform;
...
var DataDiffer, DataDiffer_default;
var init_DataDiffer = __esm({
  "node_modules/echarts/lib/data/DataDiffer.js"() {
    DataDiffer = /** @class */
    function() {
...
var init_dimensionHelper = __esm({
  "node_modules/echarts/lib/data/helper/dimensionHelper.js"() {
    init_util();
    init_types();
    DimensionUserOuput = /** @class */
    function() {
...
var SeriesDimensionDefine, SeriesDimensionDefine_default;
var init_SeriesDimensionDefine = __esm({
  "node_modules/echarts/lib/data/SeriesDimensionDefine.js"() {
    init_util();
    SeriesDimensionDefine = /** @class */
    /* @__PURE__ */ function() {
    ...
    SeriesDimensionDefine_default = SeriesDimensionDefine;
  }
});
...
var inner5, dimTypeShort, SeriesDataSchema;
var init_SeriesDataSchema = __esm({
  "node_modules/echarts/lib/data/helper/SeriesDataSchema.js"() {
    init_util();
    init_model();
    init_Source();
...
var isObject3, map2, CtorInt32Array2, ID_PREFIX, INDEX_NOT_FOUND, TRANSFERABLE_PROPERTIES, CLONE_PROPERTIES, prepareInvertedIndex, getId, getIdNameFromStore, normalizeDimensions, transferProperties, cloneListForMapAndSample, makeIdFromName, SeriesData, SeriesData_default;
var init_SeriesData = __esm({
  "node_modules/echarts/lib/data/SeriesData.js"() {
    init_util();
    init_Model();
    init_DataDiffer();
    ...
    isObject3 = isObject;
    map2 = map;
    CtorInt32Array2 = typeof Int32Array === "undefined" ? Array : Int32Array;
    ID_PREFIX = "e\0\0";
    INDEX_NOT_FOUND = -1;
    TRANSFERABLE_PROPERTIES = ["hasItemOption", "_nameList", "_idList", "_invertedIndicesMap", "_dimSummary", "userOutput", "_rawData", "_dimValueGetter", "_nameDimIdx", "_idDimIdx", "_nameRepeatCount"];
    CLONE_PROPERTIES = ["_approximateExtent"];
    SeriesData = /** @class */
    function() {
...
var TMP_TRANSFORM, Region, GeoJSONPolygonGeometry, GeoJSONLineStringGeometry, GeoJSONRegion, GeoSVGRegion;
var init_Region = __esm({
  "node_modules/echarts/lib/coord/geo/Region.js"() {
    ...
    GeoJSONLineStringGeometry = /** @class */
    /* @__PURE__ */ function() {
...
var uidBase, OrdinalMeta, OrdinalMeta_default;
var init_OrdinalMeta = __esm({
  "node_modules/echarts/lib/data/OrdinalMeta.js"() {
    init_util();
    uidBase = 0;
    OrdinalMeta = /** @class */
    ...
    OrdinalMeta_default = OrdinalMeta;
  }
});
...
var OrdinalScale, Ordinal_default;
var init_Ordinal = __esm({
  "node_modules/echarts/lib/scale/Ordinal.js"() {
    ...
    Ordinal_default = OrdinalScale;
  }
});

// node_modules/echarts/lib/scale/Interval.js
var roundNumber, IntervalScale, Interval_default;
var init_Interval = __esm({
  "node_modules/echarts/lib/scale/Interval.js"() {
    ...
    Interval_default = IntervalScale;
  }
});
...
var init_dataStackHelper = __esm({
  "node_modules/echarts/lib/data/helper/dataStackHelper.js"() {
    init_util();
    init_SeriesDataSchema();
  }
...
var supportFloat32Array, Float32ArrayCtor;
var init_vendor = __esm({
  "node_modules/echarts/lib/util/vendor.js"() {
    init_util();
    supportFloat32Array = typeof Float32Array !== "undefined";
    Float32ArrayCtor = !supportFloat32Array ? Array : Float32Array;
  }
});
...
var bisect, TimeScale, scaleIntervals, Time_default;
var init_Time = __esm({
  "node_modules/echarts/lib/scale/Time.js"() {
    init_tslib_es62();
    init_number();
...
var scaleProto, intervalScaleProto, roundingErrorFix, mathFloor, mathCeil, mathPow, mathLog, LogScale, proto, Log_default;
var init_Log = __esm({
  "node_modules/echarts/lib/scale/Log.js"() {
    init_tslib_es62();
    init_util();
    ...
    init_helper2();
    init_Interval();
    scaleProto = Scale_default.prototype;
    intervalScaleProto = Interval_default.prototype;
    roundingErrorFix = round;
...
var ScaleRawExtentInfo, DETERMINED_MIN_MAX_ATTR, DATA_MIN_MAX_ATTR;
var init_scaleRawExtentInfo = __esm({
  "node_modules/echarts/lib/coord/scaleRawExtentInfo.js"() {
    init_util();
    init_text();
    ScaleRawExtentInfo = /** @class */
    function() {
...
var inner6;
var init_axisTickLabelBuilder = __esm({
  "node_modules/echarts/lib/coord/axisTickLabelBuilder.js"() {
    init_util();
    init_text();
    init_model();
...
var NORMALIZED_EXTENT, Axis, Axis_default;
var init_Axis = __esm({
  "node_modules/echarts/lib/coord/Axis.js"() {
    init_util();
    init_number();
    init_axisTickLabelBuilder();
    NORMALIZED_EXTENT = [0, 1];
    Axis = /** @class */
    function() {
...
var init_axisModelCommonMixin = __esm({
  "node_modules/echarts/lib/coord/axisModelCommonMixin.js"() {
    AxisModelCommonMixin = /** @class */
    function() {
...
var init_labelLayoutHelper = __esm({
  "node_modules/echarts/lib/label/labelLayoutHelper.js"() {
    init_graphic2();
  }
});
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-EXFL2HOC.js.map
