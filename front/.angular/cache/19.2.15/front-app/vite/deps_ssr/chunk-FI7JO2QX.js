...
var init_createDimensions = __esm({
  "node_modules/echarts/lib/data/helper/createDimensions.js"() {
    init_types();
    init_SeriesDimensionDefine();
    init_util();
...
var CoordSysInfo, fetchers;
var init_referHelper = __esm({
  "node_modules/echarts/lib/model/referHelper.js"() {
    init_util();
    init_model();
    CoordSysInfo = /** @class */
...
var createSeriesData_default;
var init_createSeriesData = __esm({
  "node_modules/echarts/lib/chart/helper/createSeriesData.js"() {
    init_util();
    init_SeriesData();
    ...
    init_sourceHelper();
    init_types();
    createSeriesData_default = createSeriesData;
  }
});
...
var PI2, CMD, DEFAULT_SEARCH_SPACE, tmpPt, pt0, pt1, pt2, dir, dir2, tmpArr, tmpProjPoint;
var init_labelGuideHelper = __esm({
  "node_modules/echarts/lib/label/labelGuideHelper.js"() {
    init_graphic();
    init_PathProxy();
    init_util2();
    ...
    tmpPt = [];
    pt0 = new Point_default();
    pt1 = new Point_default();
    pt2 = new Point_default();
    dir = new Point_default();
    dir2 = new Point_default();
    tmpArr = [];
    tmpProjPoint = new Point_default();
  }
});
...
//# sourceMappingURL=chunk-FI7JO2QX.js.map
